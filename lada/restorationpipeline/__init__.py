...
def load_models(
    ...
    if mosaic_restoration_model_name.startswith("deepmosaics"):
        ...
        _model = loadmodel.video(device, mosaic_restoration_model_path, fp16_restoration)
        ...
        _model = load_model(mosaic_restoration_config_path, mosaic_restoration_model_path, device, fp16_restoration)
        mosaic_restoration_model = BasicvsrppMosaicRestorer(_model, device, fp16_restoration)
        pad_mode = 'zero'
    else:
    ...
    if detect_face_mosaics:
        ...
        classes = None
    mosaic_detection_model = Yolo11SegmentationModel(mosaic_detection_model_path, device, classes=classes, conf=0.15, fp16=fp16_detection)
